...
\definecolor{colour5}{HTML}{FFCC33}
\definecolor{colour6}{HTML}{CC99CC}
\definecolor{colour7}{HTML}{9966FF}
\definecolor{colour8}{HTML}{66FF99}
\definecolor{colour9}{HTML}{FFCC33}
\begin{document}
\title{\color{blue}\Large\textbf{RAJIV GANDHI UNIVERSITY OF KNOWLEDGE TECHNOLOGIES,}}
\author{\color{blue}\large\textbf{Basar(Village \& Mandal),Nirmal(District),Telangana State – 504107 }}

\date{\color{red}\textbf{DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING}}

\maketitle
\hline
\section*{\centering{LATEX Assignment -1}}
\section*{\Large\textbf{Contents}}
\subsection*{\textbf{1 Knitting Patterns}}
    \subsection*{2 Chess Notation}
    \subsection*{{3Chemistry}}
  \subsection*{3.1 Chemical Formulae\\
  3.2 Molecular Orbital Diagrams}
\subsection*{{4 Electrical Circuits}}
\subsection*{{5 Typesetting exams}}

\section{ Knitting Patterns}
\large{This class provides a very convenient way to introduce boxed diagrams. We are thus going to use our stock image a few more
...
\fbox{\includegraphics[scale=0.6]{graph.png}}
\end{figure}
\important{colour0}{colour5}{We have a way of highlighting important text, or as was originally intended, important
...
\fbox{\includegraphics[width=7.5cm,height=6cm]{graph.png}}
\end{figure}
\end{minipage} \hfill
...
\chessboard[setfen=rnb1k1nr/p2p1ppp/3B/1pbN1N1P/4P1P/3P1Q/PqP/R4kR,showmover=false]\\
\end{center}
...
\newchessgame
\setchessboard{boardfontsize=18}
\chessboard[setfen=r1bk2nr/p2p1pNp/n2B1Q/1p1NP2P/6P/3P/P1P1K/q5b,showmover=false]
\end{center}
A brilliant Queen sacrifice to deflect the Knight on g8 that protects e7 22. . . \symknight xf6 23 \symbishop e7\#
\begin{center}
    \newchessgame
    \setchessboard{boardfontsize=18}
\chessboard[setfen=r1bk3r/p2pBpNp/n4n/1p1NP2P/6P/3P/P1P1K/q5b,showmover=false]
\end{center}
